...
class ErrorPersonalScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Errores de personal',style: TextStyle(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/nuevoErrorPersonal');
        },
