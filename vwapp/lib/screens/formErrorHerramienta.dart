...
class FormErrorHerramienta extends StatefulWidget {
  @override
  _FormErrorHerramientaState createState() => _FormErrorHerramientaState();
}

class _FormErrorHerramientaState extends State<FormErrorHerramienta> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Nuevo error de herramientas',style: TextStyle(
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (tipoErrorController.text.isNotEmpty &&
                      ...
                      final errorProvider = Provider.of<HerramientaProvider>(
                        context,
                        listen: false,
                      );
                      ...
                      _mostrarAlerta(context,
                          'Error de herramientas insertado correctamente');
