...
class FormModificarErrorLinea extends StatefulWidget {
  @override
  _FormModificarErrorLinea createState() => _FormModificarErrorLinea();
}

class _FormModificarErrorLinea extends State<FormModificarErrorLinea> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Modificar error línea de producción',style: TextStyle(
                          ...
                          onPressed: () async {
                            if (idController.text.isNotEmpty &&
                              ...
                              _mostrarAlerta(context,
                                  'Error de líneas de producción actualizado correctamente');
                            } else {
