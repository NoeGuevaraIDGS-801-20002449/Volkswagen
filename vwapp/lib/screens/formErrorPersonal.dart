...
class FormErrorPersonal extends StatefulWidget {
  @override
  _FormErrorPersonalState createState() => _FormErrorPersonalState();
}

class _FormErrorPersonalState extends State<FormErrorPersonal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Nuevo error de personal',style: TextStyle(
              color: Colors.white, // Color blanco
            ),),
        leading: IconButton(
          icon: Icon(Icons.arrow_back,color: Colors.white,), // Icono de regreso
          onPressed: () {
            Navigator.pushReplacementNamed(context, '/errorPersonal');
          },
        ),
      ),
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (tipoErrorController.text.isNotEmpty &&
                      ...
                      final errorProvider = Provider.of<PersonalProvider>(
                        context,
                        listen: false,
                      );
                      ...
                      _mostrarAlerta(
                          context, 'Error de personal insertado correctamente');
