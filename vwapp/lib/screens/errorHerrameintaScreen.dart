...
class ErrorHerramientaScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Errores de herramientas',style: TextStyle(
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.pushNamed(
                        context,
                        '/detalle_error_herramienta_screen',
                        arguments: index,
                      ),
                      child: Padding(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/nuevoErrorHerramienta');
        },
