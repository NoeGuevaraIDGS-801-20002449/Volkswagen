...
class FormModificarErrorPersonal extends StatefulWidget {
  @override
  _FormModificarErrorPersonal createState() => _FormModificarErrorPersonal();
}

class _FormModificarErrorPersonal extends State<FormModificarErrorPersonal> {
  ...
  Widget build(BuildContext context) {
    ...
    final pdProvider = Provider.of<PersonalProvider>(context);
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Modificar error personal',style: TextStyle(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacementNamed(
                context, '/detalle_error_personal_screen',
                          ...
                          onPressed: () async {
                            if (idController.text.isNotEmpty &&
                              ...
                              _mostrarAlerta(context,
                                  'Error de personal actualizado correctamente');
                            } else {
