...
class LineaProvider extends ChangeNotifier {
  ...
  Future<void> insertarError(
    ...
    final String url = '${_urlBase}ErrorLineaProduccion';
    String nivelC = '0';
  ...
  Future<void> actualizarError(
    ...
    final String url = '${_urlBase}ErrorLineaProduccion/$id';
    String nivelC = '0';
    if (nivel == 'colaborador') {
      nivelC = '1';
    } else if (nivel == 'supervisor') {
  ...
  Future<void> getError() async {
    ...
    final String url = '${_urlBase}ErrorLineaProduccion/ByUserRole/$userId';
    try {
  ...
  Future<void> deleteError(int idError) async {
    final String url = '${_urlBase}ErrorLineaProduccion/$idError';
    try {
  ...
  Future<void> subirNivel(int idError) async {
    final String url =
        '${_urlBase}ErrorLineaProduccion/SubirNivelErrorLineaProduccion/$idError';
    try {
