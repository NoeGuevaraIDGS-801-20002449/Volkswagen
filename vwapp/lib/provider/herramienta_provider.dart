...
class HerramientaProvider extends ChangeNotifier {
  ...
  Future<void> insertarError(
    ...
    final String url = '${_urlBase}ErrorHerramientas';
    String nivelC = '0';
  ...
  Future<void> actualizarError(
    ...
    final String url = '${_urlBase}ErrorHerramientas/$id';
    String nivelC = '0';
    if (nivel == 'colaborador') {
      nivelC = '1';
    } else if (nivel == 'supervisor') {
  ...
  Future<void> getError() async {
    ...
    final String url = '${_urlBase}ErrorHerramientas/ByUserRole/$userId';
    try {
  ...
  Future<void> deleteError(int idError) async {
    final String url = '${_urlBase}ErrorHerramientas/$idError';
    try {
  ...
  Future<void> subirNivel(int idError) async {
    final String url =
        '${_urlBase}ErrorHerramientas/SubirNivelErrorHerramienta/$idError';
    try {
